...
<head>
    ...
    <link rel="stylesheet" href="css/StyleETODER.css">
</head>
...
<article class="ft-container">
  <div class="son-container">
    <h2>ADVERTENCIA</h2>
    <p>
      DEBES DE RELLENAR TODOS LOS CAMPOS PARA PODER REGISTRAR LA SALIDA, VERIFICA LOS DATOS E INTENTALO NUEVAMENTE.
    </p>
    <div class="form-buttons">
      <a href="exitord.php"><button type="submit" class="btn confirm">CONFIRMAR</button></a>
    </div>
  </div>
</article>
...
<main class="salida-container">
    ...
    <div class="salida-tabs">
        ...
        <button class="tab">SALIDA SIN ORDEN (USO INTERNO)</button>
    </div>
