...
error_log("Exit without order - Area: $area, Manager: $encargado, Elements: " . count($elementos));
...
try {
    foreach ($elementos as $item) {
        ...
        $sqlInsert = "INSERT INTO SalidaSinorden (areaSolicitante, encargadoArea, fecha, comentarios, idCodigo, cantidad)
                      VALUES (?, ?, ?, ?, ?, ?)";
        $stmtInsert = sqlsrv_query($conn, $sqlInsert, [$area, $encargado, $fecha, $comentarios, $idCodigo, $cantidad]);
