...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    die('Error: Este archivo solo acepta solicitudes POST. Por favor, use el formulario.');
}
...
error_log("Admin entry - Product: $idCodigo, Provider: $idProveedor, Quantity: $cantidad");
...
try {
    ...
    if (!$rowCaja) {
        // No CajaRegistro exists, try to create one
    ...
    error_log("Admin entry registered successfully - redirecting to confirmation page");
    ...
    echo "</div>";
    echo "<p><a href='../admnedtet.php'>← Volver al formulario</a></p>";
    echo "</body></html>";
    exit();
}
?>