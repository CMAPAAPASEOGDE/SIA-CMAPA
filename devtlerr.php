...
<html>
<head>SIA WARNING</title>
    <link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>📦</text></svg>">
    <meta charset="UTF-8" />
    <link rel="stylesheet" href="css/StyleDVTLER.css">
</head>
...
<article class="ft-container">
  <div class="son-container">
    <h2>ADVERTENCIA</h2>
    <p>
      ESTA HERRAMIENTA YA NO SE ENCUENTRA EN LA DB O YA ESTA EN ALMACEN
    </p>
    <div class="form-buttons">
      <a href="devotool.php"><button type="submit" class="btn confirm">CONFIRMAR</button></a>
    </div>
  </div>
</article>
