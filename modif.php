...
<head>
    ...
    <title>SIA Modifications</title>
    <link rel="stylesheet" href="css/StyleMDF.css">
</head>
...
<main class="modificaciones-container">
    <div class="modificaciones-title">
        <h2>MODIFICACIONES</h2>
    </div>
    <div class="modificaciones-menu">
        <a href="modfalt.php"><button class="btn">SOLICITAR ALTAS</button></a>
        <a href="modbjs.php"><button class="btn">SOLICITAR BAJAS</button></a>
        <a href="modedtdtls.php"><button class="btn">MODIFICAR DETALLES</button></a>
    </div>
    <div class="modificaciones-cancelar">
        <a href="warehouse.php"><button class="btn">CANCELAR</button></a>
    </div>
</main>
