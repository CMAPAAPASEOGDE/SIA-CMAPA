...
<head>
    ...
    <link rel="stylesheet" href="css/StyleADUSEDSHER.css">
</head>
...
<article class="ft-container">
  <div class="son-container">
    <h2>ADVERTENCIA</h2>
    <p>
      EL USUARIO QUE INTENTAS BUSCAR NO EXISTE. <br>
      VERIFICA LOS DATOS E INTENTALO NUEVAMENTE.
    </p>
    <div class="form-buttons">
      <a href="admnusredsrch.php"><button type="submit" class="btn confirm">CONFIRMAR</button></a>
    </div>
  </div>
</article>
