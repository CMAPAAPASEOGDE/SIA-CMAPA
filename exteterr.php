...
<head>
    ...
    <link rel="stylesheet" href="css/StyleEXETER.css">
</head>
...
<article class="ft-container">
  <div class="son-container">
    <h2>ADVERTENCIA</h2>
    <p>
      LA CANTIDAD QUE DESEAS INGRESAR EXCEDE EL SOBRESTOCK, SI NECESITAS INGRESAR ESA CANTIDAD CONTACTA CON UN ADMINISTRADOR.
    </p>
    <div class="form-buttons">
      <a href="warehouse.php"><button type="button" class="btn confirm">CONTINUAR</button></a>
    </div>
  </div>
</article>
