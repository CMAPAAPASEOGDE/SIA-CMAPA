...
<head>
    ...
    <link rel="stylesheet" href="css/StyleNWETER.css">
</head>
...
<article class="ft-container">
  <div class="son-container">
    <h2>ADVERTENCIA</h2>
    <p>
      EL CODIGO QUE DESEAS ASIGNAR YA ESTA ASIGNADO A OTRO ELEMENTO, INTENTA CON UN CODIGO DIFERENTE.
    </p>
    <div class="form-buttons">
      <a href="nwentry.php"><button type="submit" class="btn confirm">CONFIRMAR</button></a>
    </div>
  </div>
</article>
